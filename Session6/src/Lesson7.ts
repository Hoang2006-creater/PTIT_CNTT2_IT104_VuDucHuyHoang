...
allStudent.push(
    new Students(1, "Nguyen Văn A"),
    new Students(2, "Nguyen Thị B"),
    new Students(3, "Nguyen Văn C"),
    new Students(4, "Nguyen Thị D"),
    new Students(5, "Nguyen Văn E"),
    new Students(6, "Nguyen Thị F")
)
