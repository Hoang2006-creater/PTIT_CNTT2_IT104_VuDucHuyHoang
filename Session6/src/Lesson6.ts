...
allStudents.push(
    new Student(1, "Nguyen Văn A"),
    new Student(2, "Nguyen Thị B"),
    new Student(3, "Nguyen Văn C"),
    new Student(4, "Nguyen Thị D"),
    new Student(5, "Nguyen Văn E"),
    new Student(6, "Nguyen Thị F")
)
